...
return [
    ...
    'directory' => [
        'create_fail' => "Qovluq yarada bilmir: :name",
    ],
    'file' => [
        'create_fail' => "Fayl yaradıla bilmir: :name",
    ],
    'page' => [
        'invalid_token' => [
            'label' => 'Etibarsız təhlükəsizlik açarı',
        ],
    ],
    'combiner' => [
        'not_found' => "Birləşdirilmiş faylı: ':name' tapılmadı.",
    ],
    'system' => [
        'name' => 'Sistem',
        'menu_label' => 'Sistem',
