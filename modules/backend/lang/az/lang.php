...
return [
    'auth' => [
        ...
        'invalid_login' => 'Daxil etdiyiniz məlumatlar qeydlərə uyğun deyil. Xahiş edirəm yoxlayın və yenidən cəhd edin.',
    ],
    'field' => [
    ...
    'account' => [
        ...
        'restore_error' => "':login' istifadəçi adı tapılmadı.",
    ...
    'user' => [
        'name' => 'İdarəçi',
        'menu_label' => 'İdarəçilər',
        'menu_description' => 'İdarəetmə panel qruplarını, istifadəçilərini və icazələrini idarə edin.',
        'list_title' => 'Menecerləri idarə edin',
        'new' => 'Yeni Yönetici',
        ...
        'avatar' => "Avatar",
        'password' => "Şifrə",
        'password_confirmation' => "Şifrə (Yenidən)",
        'permissions' => 'İzinler',
        'account' => 'Hesab',
    ...
    'list' => [
        ...
        'pagination' => 'Göstərilənlər: :from-:to Cəmi: :total',
        ...
        'loading' => 'Yükleniyor...',
        'setup_title' => 'Siyahı Parametrləri',
        'setup_help' => 'Siyahıda görmək istədiyiniz sütunları seçmək üçün onay qutularından istifadə edin. Sütunları yuxarı və ya aşağı sürükləyərək mövqelərini dəyişə bilərsiniz.',
        'records_per_page' => 'Hər səhifədə qeydlərin sayı',
        'records_per_page_help' => 'Hər səhifədə göstəriləcək qeydlərin sayını seçin. Bir səhifədə çox sayda qeydə baxmaq sistemin fəaliyyətini azalda bilər.',
        'check' => 'Kontrol et',
        'delete_selected' => 'Seçilmişləri silin',
    ...
    'form' => [
        ...
        'create' => 'Yarat',
        'create_and_close' => 'Yarat və Bağla',
        'creating' => 'Oluşturuluyor...',
        'creating_name' => 'Oluşturuluyor :name...',
        'save' => 'Yadda saxla',
        'save_and_close' => 'Yadda saxla və bağla',
        'saving' => 'Kaydediliyor...',
        ...
        'reset_default' => 'Əvvəlcədən təyin edilmiş parametrlərə qayıdın!',
        'resetting' => 'İşleniyor',
        ...
        'return_to_list' => 'Siyahıya qayıdın',
    ],
    'recordfinder' => [
    ...
    'reorder' => [
        'default_title' => 'Qeydləri yenidən sırala',
    ...
    'tooltips' => [
        'preview_website' => 'Veb saytına bax',
    ],
    'mysettings' => [
    ...
    'media' => [
        ...
        'move' => 'Daşı',
        'delete' => 'Sil',
        'add_folder' => 'Yeni qovluq',
        'search' => 'Axtar',
        'display' => 'Göstər',
        'filter_everything' => 'Hər şey',
        'filter_images' => 'Şəkillər',
        'filter_video' => 'Video',
        'filter_audio' => 'Səs',
        ...
        'size' => 'Ölçü',
        'title' => 'Başlıq',
        'last_modified' => 'Son redaktə tarixi',
        'public_url' => 'Public URL',
        'click_here' => 'Buraya vurun',
        'thumbnail_error' => 'Önizləmə yaratma xətası.',
        'return_to_parent' => 'Əsas qovluğa qayıdın',
        'return_to_parent_label' => 'Yuxarı get',
        'nothing_selected' => 'Heç nə seçilmədi.',
